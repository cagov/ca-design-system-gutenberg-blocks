...
function ca_design_system_register_card_grid()
{
    ...
    wp_register_script(
        'ca-design-system-card-grid-editor',
        plugins_url('block.js', __FILE__),
        array('wp-blocks', 'wp-i18n', 'wp-element', 'wp-editor', 'underscore'),
        filemtime(plugin_dir_path(__FILE__) . 'block.js')
    );

    wp_register_style( 'ca-design-system-card-grid-style', false );
    $style_css = file_get_contents(plugin_dir_path(__FILE__) . '/style.css', __FILE__);
    wp_add_inline_style('ca-design-system-card-grid-style', $style_css);
    ...
    register_block_type('ca-design-system/card-grid', array(
        'style' => 'ca-design-system-card-grid-style',
        'editor_style' => 'ca-design-system-accordion-editor-style',
        'editor_script' => 'ca-design-system-card-grid-editor',
    ));
}
