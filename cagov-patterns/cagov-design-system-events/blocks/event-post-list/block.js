...
(function (blocks, editor, i18n, element, components, _, moment) {
  ...
  blocks.registerBlockType("ca-design-system/event-post-list", {
    ...
    example: {
      attributes: {
        title: __("Upcoming events", "ca-design-system"),
    ...
    edit: function (props) {
      ...
      return el(
        "div",
        {
          className: "cagov-event-post-list cagov-stack",
        },
        el(
          "div",
          {},
          el(RichText, {
            tagName: "div",
            className: "event-post-list-title",
            inline: false,
            placeholder: __("Event post list title", "ca-design-system"),
          ...
          // ),
          el("hr"),
          el("h3", { children: "Event post list settings"}),
          el(
            "div",
            { className: "edit" },
            // @TODO Change to select with categories list.
            el(TextControl, {
              label: "Change event post category",
              tagName: "div",
            ...
            el(TextControl, {
              ...
              tagName: "div",
              className: "event-post-list-count",
            ...
            el(ToggleControl, {
              ...
              tagName: "div",
              className: "event-post-list-order",
              inline: false,
            ...
            el(CheckboxControl, {
              ...
              className: "event-post-list-excerpt",
            ...
            el(CheckboxControl, {
              ...
              tagName: "div", // select box + enter data
              className: "event-post-list-published-date",
            ...
            el(CheckboxControl, {
              ...
              tagName: "div", // select box + enter data
              className: "event-post-list-pagination",
            ...
            el(TextControl, {
              label: "Endpoint",
              tagName: "div", // select box + enter data
              className: "event-post-list-endpoint",
              inline: false,
              // type: "hidden",
