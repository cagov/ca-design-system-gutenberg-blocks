 ...
 */
function ca_design_system_press_release_post_custom_wp_block_patterns() {
...
add_action( 'init', 'ca_design_system_press_release_post_custom_wp_block_patterns' );


function ca_design_system_press_release_post_web_component_scripts() {
    // Global dependencies
    wp_enqueue_script(
        'moment'
    );
...
add_action('wp_enqueue_scripts', 'ca_design_system_press_release_post_web_component_scripts');