...
/**
 * Plugin Name: CA Design System Recent News Pattern
 * Plugin URI: TBD
 * Description: TBD
 * Version: 1.1.0
 ...
 */
function ca_design_system_recent_news_custom_wp_block_patterns() {
    ...
    register_block_pattern(
        ...
        array(
            'title'       => __( 'Recent News', 'ca-design-system' ),
            'description' => _x( 'Recent News Blocks ', 'Block pattern description', 'ca-design-system' ),
...
add_action( 'init', 'ca_design_system_recent_news_custom_wp_block_patterns' );


function ca_design_system_recent_news_web_component_scripts() {
    // Global dependencies
    wp_enqueue_script(
        'moment'
    );
...
add_action('wp_enqueue_scripts', 'ca_design_system_recent_news_web_component_scripts');