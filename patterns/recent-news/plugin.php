...
/**
 * Plugin Name: Recent News Pattern
 * Plugin URI: TBD
 * Description: TBD
 * Version: 1.1.0
 ...
 */
function cagov_design_system_recent_news_custom_wp_block_patterns() {
    ...
    register_block_pattern(
        ...
        array(
            'title'       => __( 'Recent News', 'cagov' ),
            'description' => _x( 'Recent News Blocks ', 'Block pattern description', 'cagov' ),
...
add_action( 'init', 'cagov_design_system_recent_news_custom_wp_block_patterns' );


function cagov_design_system_recent_news_web_component_scripts() {
    // Global dependencies
    wp_enqueue_script(
        'moment'
    );
...
add_action('wp_enqueue_scripts', 'cagov_design_system_recent_news_web_component_scripts');