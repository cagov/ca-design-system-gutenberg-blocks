 ...
 */
function cagov_design_system_news_post_custom_wp_block_patterns() {
    ...
    register_block_pattern(
        ...
        array(
            'title'       => __( 'News Post', 'cagov' ),
            'description' => _x( 'Page layout for News page', 'Block pattern description', 'cagov' ),
...
add_action( 'init', 'cagov_design_system_news_post_custom_wp_block_patterns' );


function cagov_design_system_news_post_web_component_scripts() {
    // Global dependencies
    wp_enqueue_script(
        'moment'
    );
...
add_action('wp_enqueue_scripts', 'cagov_design_system_news_post_web_component_scripts');