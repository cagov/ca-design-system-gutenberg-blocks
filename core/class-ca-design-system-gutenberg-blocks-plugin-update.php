...
if ( ! class_exists( 'CADesignSystemGutenbergBlocks_Plugin_Update' ) ) {
	...
	class CADesignSystemGutenbergBlocks_Plugin_Update {
		 ...
		 */
		protected $transient_name = 'ca_design_system_gutenberg_blocks_design_system_gutenberg_blocks_update_plugins';
		...
		public function __construct( $plugin_slug ) {
			...
			add_filter( 'pre_set_site_transient_update_plugins', array( $this, 'ca_design_system_gutenberg_blocks_design_system_gutenberg_blocks_check_plugin_update' ) );

			// Define the alternative response for information checking.
			add_filter( 'site_transient_update_plugins', array( $this, 'ca_design_system_gutenberg_blocks_design_system_gutenberg_blocks_add_plugins_to_update_notification' ) );

			add_filter( 'plugins_api', array( $this, 'ca_design_system_gutenberg_blocks_design_system_gutenberg_blocks_update_plugins_changelog' ), 20, 3 );
			...
			add_filter( 'upgrader_source_selection', array( $this, 'ca_design_system_gutenberg_blocks_design_system_gutenberg_blocks_upgrader_source_selection' ), 10, 4 );
		 ...
		 * @return array
		 */
		public function ca_design_system_gutenberg_blocks_design_system_gutenberg_blocks_check_plugin_update( $update_transient ) {
		 ...
		 * @return array
		 */
		public function ca_design_system_gutenberg_blocks_design_system_gutenberg_blocks_add_plugins_to_update_notification( $update_transient ) {
			$ca_design_system_gutenberg_blocks_design_system_gutenberg_blocks_update_plugins = get_site_transient( $this->transient_name );
			if ( ! is_object( $ca_design_system_gutenberg_blocks_design_system_gutenberg_blocks_update_plugins ) || ! isset( $ca_design_system_gutenberg_blocks_design_system_gutenberg_blocks_update_plugins->response ) ) {
				return $update_transient;
			}
			...
			$update_transient->response = array_merge(
				...
				$ca_design_system_gutenberg_blocks_design_system_gutenberg_blocks_update_plugins->response
			);
		 ...
		 */
		public function ca_design_system_gutenberg_blocks_design_system_gutenberg_blocks_update_plugins_changelog( $result, $action, $args ) {
			if ( isset( $args->slug ) && $args->slug === $this->slug ) {
				$ca_design_system_gutenberg_blocks_design_system_gutenberg_blocks_update_plugins = get_site_transient( $this->transient_name );
				if ( isset( $ca_design_system_gutenberg_blocks_design_system_gutenberg_blocks_update_plugins->response ) && isset( $ca_design_system_gutenberg_blocks_design_system_gutenberg_blocks_update_plugins->response[ $this->plugin_file ] ) ) {
					$tmp = $this->plugin_details();

					$tmp['version']      = $ca_design_system_gutenberg_blocks_design_system_gutenberg_blocks_update_plugins->response[ $this->plugin_file ]->new_version;
					$tmp['last_updated'] = $ca_design_system_gutenberg_blocks_design_system_gutenberg_blocks_update_plugins->response[ $this->plugin_file ]->published_date;

					$tmp['sections']['Changelog'] = $this->ca_design_system_gutenberg_blocks_design_system_gutenberg_blocks_get_plugin_changelog( $tmp['version'] );
		 ...
		 * @return string
		 */
		public function ca_design_system_gutenberg_blocks_design_system_gutenberg_blocks_get_plugin_changelog( $ver = 'master' ) {
		 ...
		 * @return string
		 */
		public function ca_design_system_gutenberg_blocks_design_system_gutenberg_blocks_upgrader_source_selection( $src, $rm_src, $upgr, $options ) {
