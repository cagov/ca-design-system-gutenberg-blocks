...
blocks.registerBlockType("ca-design-system/event-detail", {
  ...
  edit: function (props) {
    ...
    let formattedEndTime = endTime; // https://developer.wordpress.org/block-editor/reference-guides/components/date-time/
    // <OptionsExample {...props} />
    ...
    return createElement("div", useBlockProps(), createElement(RichText, {
      ...
      class: "startDate"
    }, formattedStartDate), createElement("div", {
      class: "endDate"
    }, formattedEndDate), " ", createElement("br", null), createElement("div", {
      class: "startTime"
    }, formattedStartTime), createElement("div", {
      class: "endTime"
    }, formattedEndTime), createElement(InspectorControls, {
      key: "setting"
    }, createElement("div", {
      id: "datetime-controls"
    }, createElement("fieldset", null, createElement("legend", {
      className: "blocks-base-control__label"
    }, __("Start Date & Time", "ca-design-system")), createElement(StartDateTimePicker, null)), createElement("fieldset", null, createElement("legend", {
      className: "blocks-base-control__label"
    }, __("End Date & Time", "ca-design-system")), createElement("em", null, "End date and time are optional."), createElement(EndDateTimePicker, null))))), createElement("div", {
      class: "detail-section"
