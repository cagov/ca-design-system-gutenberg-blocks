...
blocks.registerBlockType("ca-design-system/event-detail", {
  ...
  example: {
    attributes: {// startDate: __("Start Data & Time", "ca-design-system"),
    }
  },
  edit: function (props) {
    var attributes = props.attributes; //   const { startDate } = attributes;
    ...
    return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])("h1", null, "Hi"); //   return el(
    //     "div",
