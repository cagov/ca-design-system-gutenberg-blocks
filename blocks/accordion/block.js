...
(function (blocks, blockEditor, i18n, element, components, _) {
  ...
  blocks.registerBlockType("ca-design-system/accordion", {
    ...
    icon:  "plus-alt",
    description: __("An expandable section of content. Can be used on any standard content page. Allows information that is not applicable to the majority of readers to be initially hidden, and opened on demand. Includes accordion label, button, and body content. The label can be a question or a title.", "ca-design-system"),
...
return el("cagov-accordion",
    ...
    el("button", {className: "card-header accordion-alpha", type: "button", ariaExpanded: false},
      el("div", {className: "accordion-title"},
    ...
    el("div",  {className: "card-container", type: "button", ariaHidden: true, style: {height: '0px'}},
