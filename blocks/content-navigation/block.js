 ...
 */
 ...
 (function (blocks, blockEditor, i18n, element, components, _, moment) {
	...
	blocks.registerBlockType("cagov/news-list", {
	  title: __("CAGov: Content Navigation", "cagov-design-system"),
	  ...
	  example: {
		attributes: {
		  title: __("Content Navigation title", "cagov-design-system"),
		  description: __("Content Navigation description", "cagov-design-system"),
		...
		return el(
		  ...
		  el(
			...
			el(RichText, {
			  tagName: "h3",
			  inline: false,
			  placeholder: __("Content Navigation title", "cagov-design-system"),
			...
			//   inline: false,
			//   placeholder: __(
			//     "Content Navigation message (optional)",
			//     "cagov-design-system"
			//   ),
