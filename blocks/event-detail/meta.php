...
function cagov_event_detail_load_scripts() {
	$dir = __DIR__;
	...
	// wp_register_script(
	// 	'cagov-event-detail-script',
	// 	plugins_url( $index_js, __FILE__ ),
	// 	$script_asset['dependencies'],
	// 	$script_asset['version']
	// );

	// $fields = apply_filters( 'cagov_event_detail_register_fields', [] );
	// $data   = [
	// 	'fields'      => $fields,
	// ];
	// wp_localize_script( 'cagov-event-detail-script', 'cagov_event_detail_data', $data );

	// wp_enqueue_script('cagov-event-detail-script');
}

// add_action( 'admin_enqueue_scripts', 'cagov_event_detail_load_scripts' );