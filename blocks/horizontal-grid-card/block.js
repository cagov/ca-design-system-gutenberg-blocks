...
(function (blocks, editor, i18n, element, components, _) {
  ...
  blocks.registerBlockType('ca-design-system/horizontal-grid-card', {
    title: __('Horizontal grid card', 'cagov-design-system'),
      ...
      return el('div', { className: 'cagov-with-sidebar cagov-with-sidebar-left cagov-featured-section cagov-bkgrd-gry' },
        el('div', {},
          el('div', { className: 'cagov-stack cagov-p-2 cagov-featured-sidebar' },
            ...
            el(
              'div',
              { className: 'cagov-horizontal-grid-card-body-content' },
    ...
    save: function (props) {
      ...
      return el('div', { className: 'cagov-with-sidebar cagov-with-sidebar-left cagov-featured-section cagov-bkgrd-gry cagov-block' },
        el('div', {},
          el('div', { className: 'cagov-stack cagov-p-2 cagov-featured-sidebar' },
            { className: 'cagov-horizontal-grid-card cagov-stack' },
            el(RichText.Content, {
              tagName: 'h2',
              value: attributes.title
            }),
            el('div', { className: 'cagov-horizontal-grid-card-body-content' },
